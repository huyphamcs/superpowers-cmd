...
```
Explore project context → Offer visual companion (if needed) → Ask clarifying questions
→ Propose 2-3 approaches → Present design sections → User approves design?
→ Write design doc → Spec self-review → User reviews spec?
